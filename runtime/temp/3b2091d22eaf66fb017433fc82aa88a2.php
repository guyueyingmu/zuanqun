<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"C:\Object\zuanqun\web/../app/console\view\default\article\helpdoc.html";i:1518053226;s:57:"C:\Object\zuanqun\app\console\view\default\base\base.html";i:1517531928;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="link-body">
    <div class="link-item">
        <div class="layui-fluid">
            <div class="layui-card-header">帮助文档管理</div>
            <div class="layui-card-body">
                <div class="zq-form">
                    <form id="doc" class="layui-form" action="" lay-filter="component-form-group">
                        ...
                        <div class="layui-form-item">
                            <div id="markdown">
                                <textarea id="helpdoc" name="helpdoc" style="display: none;"></textarea>
                            </div>
                        </div>
