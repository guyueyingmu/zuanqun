...
namespace app\logic;
use app\logic\goods\GoodsInterface;
use app\logic\goods\GoodsException;
...
class Goods
{
    ...
    static public function set($alias,GoodsInterface $object)
    {
        if(self::exists($alias)){
            throw new GoodsException('已经设置实例对象');
        }
    ...
    {
        if(!self::exists($alias)){
            throw new GoodsException('未设置实例对象');
        }
